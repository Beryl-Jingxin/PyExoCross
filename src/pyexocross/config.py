...
class Config:
    ...
    def to_globals(self):
        ...
        try:
            import pyexocross.base.input as _input_mod
            _qn_attrs = {
                'global_qn_label_list': 'GlobalQNLabel_list',
                'global_qn_format_list': 'GlobalQNFormat_list',
                'local_qn_label_list': 'LocalQNLabel_list',
        ...
        # px.run() call would use stale values for database, profile,
        ...
        _stale_modules = [
            'pyexocross.calculation.calcualte_line_profile',
            'pyexocross.save.hitran.hitran_cross_section',
            'pyexocross.save.hitran.hitran_stick_spectra_cross_section',
        ]
